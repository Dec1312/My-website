          ...
          <div className="w-full lg:w-[40%] mt-12 lg:mt-0 relative">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs text-text-secondary uppercase tracking-wider font-semibold">Revenue Saved</div>
                  <div className="font-mono font-bold text-white text-lg">$2M+</div>
                </div>
              </div>
            </motion.div>
